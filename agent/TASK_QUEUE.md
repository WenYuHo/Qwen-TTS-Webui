...
- [x] **Sound Gen: Per-Segment Quality Scoring** — Compute SNR/clipping metrics per segment. See Track Phase 4 Task 4.1.
- [x] **Sound Gen: Auto-Retry on Low Quality** — Retry garbled segments with lower temperature. See Track Phase 4 Task 4.2.
- [x] **Sound Gen: Unit Tests for Preview & ICL** — Tests for preview text pool, ICL mode toggle. See Track Phase 5.
